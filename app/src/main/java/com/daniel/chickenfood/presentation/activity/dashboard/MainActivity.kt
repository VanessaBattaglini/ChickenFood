    ...
    Scaffold(
        ...
        Box(
            ...
            LazyColumn(
                ...
                // ✅ CORREGIDO: Mostrar PointsCard SOLO si el usuario está autenticado Y hay rewards cargados
                    ...
                    item {
                        Card(
                            ...
                            Column(
                                ...
                                Text(
                                    text = "🔐 Inicia sesión o regístrate para acceder a tu programa de puntos y disfrutar de beneficios exclusivos",
                                    fontSize = 12.sp,
